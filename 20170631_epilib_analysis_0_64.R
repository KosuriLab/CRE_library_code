...
bc_0A <- read_tsv('BCreads_txts/R0A_BC.txt')
bc_0B <- read_tsv('BCreads_txts/R0B_BC.txt')
bc_1A <- read_tsv('BCreads_txts/R1A_BC.txt')
bc_1B <- read_tsv('BCreads_txts/R1B_BC.txt')
bc_2A <- read_tsv('BCreads_txts/R2A_BC.txt')
bc_2B <- read_tsv('BCreads_txts/R2B_BC.txt')
bc_4A <- read_tsv('BCreads_txts/R4A_BC.txt')
bc_4B <- read_tsv('BCreads_txts/R4B_BC.txt')
bc_8A <- read_tsv('BCreads_txts/R8A_BC.txt')
bc_8B <- read_tsv('BCreads_txts/R8B_BC.txt')
bc_16A <- read_tsv('BCreads_txts/R16A_BC.txt')
bc_16B <- read_tsv('BCreads_txts/R16B_BC.txt')
bc_25A <- read_tsv('BCreads_txts/R25A_BC.txt')
bc_25B <- read_tsv('BCreads_txts/R25B_BC.txt')
bc_32A <- read_tsv('BCreads_txts/R32A_BC.txt')
bc_32B <- read_tsv('BCreads_txts/R32B_BC.txt')
bc_64A <- read_tsv('BCreads_txts/R64A_BC.txt')
bc_64B <- read_tsv('BCreads_txts/R64B_BC.txt')
